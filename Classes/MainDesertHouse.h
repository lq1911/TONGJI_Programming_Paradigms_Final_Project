#ifndef __MAIN_DESERT_HOUSE_H__
#define __MAIN_DESERT_HOUSE_H__

#include "MainGameScene.h"
#include "cocos2d.h"

class MainDesertHouse : public MainGameScene {
private:
...
public:
	...
	////////////////以下为本场景所有用到的初始化函数/////////////////
	/*构造函数，从上一个场景传入角色*/
	MainDesertHouse(Player* origin_player);
